...
INSERT INTO winery (id, winery_name, url_identifier, winery_owner_id) VALUES (1, 'VinoVibes Winery', '2520ff3c-8f72-11ee-b9d1-0242ac120002', 4);
INSERT INTO winery (id, winery_name, url_identifier, winery_owner_id) VALUES (2, 'WineWhiz Winery', '2520ff3c-8f72-11ee-b9d1-0249ac120005', 7);
...
INSERT INTO user (id,login, password, email, phone, active, zip_code, verified, personal_profile_id) values (2,'flo', '{bcrypt}$2a$12$hLQA4zpjoHuJLWLrv757uuiXBlZNAjIvUFRmzFN8HXvOEX5.VbRxC', 'flo@email.com', '+4915114962996',  1, 93333, true, '222cff3c-8f72-11ee-b9c1-0249ac180rw05');
INSERT INTO user (id,login, password, email, phone, active, zip_code, verified, personal_profile_id) values (3, 'markus', '{bcrypt}$2a$12$OqgFS1OcCaGndtsGCSTYo.KiW3IpT9SdFDyoCZn/0YFxH/iW3ljSG', 'markus@email.com', '+4915114962996',  1, 93333, true, '222cff3c-8f72-11ee-b9d1-0249ac320rw05');
INSERT INTO user (id,login, password, email, phone, active, zip_code, verified, personal_profile_id) values (4, 'VinoVibes', '{bcrypt}$2a$12$dEABxyOphtMwxWZGC9RpjeoE5lSU8ASwrYT0mgt4lqUeE/e.vx7jO', 'Martinwenzl191@gmail.com', '+4915114962996',  1, 93499, true, '222cff3c-8f72-11de-b9d1-0249ac120rw05');
INSERT INTO user (id,login, password, email, phone, active, zip_code, verified, personal_profile_id) values (5, 'CorkSavvy', '{bcrypt}$2a$12$hLQA4zpjoHuJLWLrv757uuiXBlZNAjIvUFRmzFN8HXvOEX5.VbRxC', 'flo3@email.com', '+4915114962996',  1, 93499, true, '222cff3c-8f72-11ee-b9d1-0249ac14drw05');
INSERT INTO user (id,login, password, email, phone, active, zip_code, verified, personal_profile_id) values (6, 'GrapeGuru', '{bcrypt}$2a$12$OqgFS1OcCaGndtsGCSTYo.KiW3IpT9SdFDyoCZn/0YFxH/iW3ljSG', 'markus3@email.com', '+4915114962996',  1, 93499, true, '222cff3c-8f72-11ee-b2d1-0249ac120rw05');
INSERT INTO user (id, login, password, email, phone, active, zip_code, verified, personal_profile_id) values (7, 'WineWhiz', '{bcrypt}$2a$12$dEABxyOphtMwxWZGC9RpjeoE5lSU8ASwrYT0mgt4lqUeE/e.vx7jO', 'Martinwenzl192@gmail.com', '+4915114962996',  1, 93499, true, '222cff3c-8f82-11ee-bkd1-0249ac120rw05');
INSERT INTO user (id,login, password, email, phone, active, zip_code, verified, personal_profile_id) values (8, 'SipSensei', '{bcrypt}$2a$12$hLQA4zpjoHuJLWLrv757uuiXBlZNAjIvUFRmzFN8HXvOEX5.VbRxC', 'flo2@email.com', '+4915114962996',  1, 93499, true, '222cff3c-8f72-11ee-b9d1-0249ac12okw05');
INSERT INTO user (id,login, password, email, phone, active, zip_code, verified, personal_profile_id) values (9, 'CellarStar', '{bcrypt}$2a$12$OqgFS1OcCaGndtsGCSTYo.KiW3IpT9SdFDyoCZn/0YFxH/iW3ljSG', 'markus2@email.com', '+4915114962996',  1, 93499, true, '222cff3c-8fk2-11ee-b9d1-0i49ac1200w05');
...
INSERT INTO user (id,login, password, email, phone, active, zip_code, verified, personal_profile_id) values (12, 'Professor_WineWizard', '{bcrypt}$2a$10$/ar/1d1eTbdnX4UqLUGOzuw910H3beBPu62EO.vaTC.aLOl5wjwu6', 'alixandre.santana@oth-regensburg.de', '+4915114962996',  1, 93051, true, '222c0f3c-8fü2-22ee-b9d1-0249ah120rw05');
INSERT INTO user (id,login, password, email, phone, active, zip_code, verified, personal_profile_id) values (13, 'Professor_Winery', '{bcrypt}$2a$10$/ar/1d1eTbdnX4UqLUGOzuw910H3beBPu62EO.vaTC.aLOl5wjwu6', 'alixandre.santana@oth-regensburg.de', '+4915114962996',  1, 93051, true, '222c0f3c-8fü2-33ee-b9d1-0249ah120rw05');
