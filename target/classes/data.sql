...
INSERT INTO user (id,login, password, email, phone, active, zip_code, verified, personal_profile_id) values (5, 'CorkSavvy', '{bcrypt}$2a$12$hLQA4zpjoHuJLWLrv757uuiXBlZNAjIvUFRmzFN8HXvOEX5.VbRxC', 'flo3@email', '+4915114962996',  1, 93499, true, '222cff3c-8f72-11ee-b9d1-0249ac14drw05');
INSERT INTO user (id,login, password, email, phone, active, zip_code, verified, personal_profile_id) values (6, 'GrapeGuru', '{bcrypt}$2a$12$OqgFS1OcCaGndtsGCSTYo.KiW3IpT9SdFDyoCZn/0YFxH/iW3ljSG', 'markus3@email', '+4915114962996',  1, 93499, true, '222cff3c-8f72-11ee-b2d1-0249ac120rw05');
...
INSERT INTO user (id,login, password, email, phone, active, zip_code, verified, personal_profile_id) values (8, 'SipSensei', '{bcrypt}$2a$12$hLQA4zpjoHuJLWLrv757uuiXBlZNAjIvUFRmzFN8HXvOEX5.VbRxC', 'flo2@email', '+4915114962996',  1, 93499, true, '222cff3c-8f72-11ee-b9d1-0249ac12okw05');
INSERT INTO user (id,login, password, email, phone, active, zip_code, verified, personal_profile_id) values (9, 'CellarStar', '{bcrypt}$2a$12$OqgFS1OcCaGndtsGCSTYo.KiW3IpT9SdFDyoCZn/0YFxH/iW3ljSG', 'markus2@email', '+4915114962996',  1, 93499, true, '222cff3c-8fk2-11ee-b9d1-0i49ac1200w05');
